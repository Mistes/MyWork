...
public class Solution
{
    ...
    static class HenFactory {
        ...
        static Hen getHen(String country) {
            ...
            else if (country == Country.MOLDOVA) {hen = new MoldovanHen();}
            else if (country == Country.RUSSIA) {hen = new RussianHen();}
            else if (country == Country.UKRAINE) {hen = new UkrainianHen();}
            else hen = null;
            return hen;
        }
    }
